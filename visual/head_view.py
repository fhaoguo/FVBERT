# coding: utf-8
# @Author     :fenghaoguo
# @Time       :2022/5/21 22:38
# @FileName   :head_view.py
# @Description:
import json
import os
import uuid
...
from .util import format_attention, num_layers, format_special_chars
...
def head_view(
    ...
    if html_action == 'view':
        ...
        vis_js = open(os.path.join(__location__, 'visual/head_view.js')).read().replace("PYTHON_PARAMS", json.dumps(params))
