...
class Module:
    ...
    .. note::
        As per the example above, an ``__init__.py()`` call to the parent class
    ...
    def register_buffer(self, name: str, tensor: Optional[Tensor], persistent: bool = True) -> None:
        ...
        considered a m2 parameter. For example, BatchNorm's ``running_mean``
        ...
        if '_buffers' not in self.__dict__:
            raise AttributeError(
                "cannot assign buffer before Module.__init__.py() call")
    ...
    def register_parameter(self, name: str, param: Optional[Parameter]) -> None:
        ...
        if '_parameters' not in self.__dict__:
            raise AttributeError(
                "cannot assign parameter before Module.__init__.py() call")
    ...
    def apply(self: T, fn: Callable[['Module'], None]) -> T:
        ...
        as well as self. Typical use includes initializing the parameters of a m2
    ...
    def cuda(self: T, device: Optional[Union[int, device]] = None) -> T:
        r"""Moves all m2 parameters and buffers to the GPU.
    ...
    def ipu(self: T, device: Optional[Union[int, device]] = None) -> T:
        r"""Moves all m2 parameters and buffers to the IPU.
        This also makes associated parameters and buffers different objects. So
        it should be called before constructing optimizer if the module will
    ...
    def xpu(self: T, device: Optional[Union[int, device]] = None) -> T:
        r"""Moves all m2 parameters and buffers to the XPU.
        This also makes associated parameters and buffers different objects. So
        it should be called before constructing optimizer if the module will
    ...
    def cpu(self: T) -> T:
        r"""Moves all m2 parameters and buffers to the CPU.
        .. note::
            This method modifies the module in-place.
        Returns:
            Module: self
    ...
    def __setattr__(self, name: str, value: Union[Tensor, 'Module']) -> None:
        ...
        if isinstance(value, Parameter):
            if params is None:
                raise AttributeError(
                    "cannot assign parameters before Module.__init__.py() call")
            ...
            if isinstance(value, Module):
                if modules is None:
                    raise AttributeError(
                        "cannot assign module before Module.__init__.py() call")
        ...
        for name, param in local_state.items():
            ...
            if key in state_dict:
                ...
                try:
                    ...
                    error_msgs.append('While copying the parameter named "{}", '
                                      'whose dimensions in the m2 are {} and '
    ...
    def named_children(self) -> Iterator[Tuple[str, 'Module']]:
        ...
        Example::
            >>> for name, module in m2.named_children():
    ...
    def requires_grad_(self: T, requires_grad: bool = True) -> T:
        ...
        or training parts of a m2 individually (e.g., GAN training).
        See :ref:`locally-disable-grad-doc` for a comparison between
    ...
    def zero_grad(self, set_to_none: bool = False) -> None:
        r"""Sets gradients of all m2 parameters to zero. See similar function
