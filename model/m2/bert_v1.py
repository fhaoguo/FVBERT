...
from .bert_inter import BertIntermediate
...
from .transformer import ModuleList
...
class BertEncoder(Module):
    def __init__(self, config):
        ...
        self.layer = ModuleList([copy.deepcopy(layer) for _ in range(config.num_hidden_layers)])
